...
class ContractAdmin(admin.ModelAdmin):
    ...
    search_fields = ["company__name","contract_id","code","partner__name","project","project_obj__name","vendor__name","kof_tan_sozlesmeye_aktarim_tarihi","lop_open_date","status"]
    list_filter = []
    inlines = []
