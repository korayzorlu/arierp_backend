...
from risk.api.serializers.to_be_transferred_serializers import *
...
class ToBeTransferredList(ModelViewSet, QueryListAPIView):
    serializer_class = ToBeTransferredListSerializer
    filterset_class = ToBeTransferredFilter
