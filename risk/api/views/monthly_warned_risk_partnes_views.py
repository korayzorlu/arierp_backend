...
class MonthlyWarnedRiskPartnerList(ModelViewSet, QueryListAPIView):
    serializer_class = MonthlyWarnedRiskPartnerListSerializer
    filterset_class = MonthlyWarnedRiskPartnerFilter
