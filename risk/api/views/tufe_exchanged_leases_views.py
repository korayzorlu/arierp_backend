...
from risk.api.serializers.tufe_exchanged_leases_serializers import *
...
class TufeExchangedLeaseList(ModelViewSet, QueryListAPIView):
    serializer_class = TufeExchangedLeaseListSerializer
    filterset_class = TufeExchangedLeaseFilter
    ...
    def get_queryset(self):
        ...
        queryset = Lease.objects.select_related(*custom_related_fields).filter(
            ...
            tufe_amount=F('tufe_fark') - (F('overdue_amount')),
