...
from risk.api.serializers.needs_to_terminated_risk_partners_serializers import *
...
class NeedsToTerminatedRiskPartnerList(ModelViewSet, QueryListAPIView):
    serializer_class = NeedsToTerminatedRiskPartnerListSerializer
    filterset_class = NeedsToTerminatedRiskPartnerFilter
