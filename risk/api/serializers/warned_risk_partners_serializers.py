...
from django.db.models import QuerySet, Q,Max,Count, Sum,When,Case,BooleanField,Value,OuterRef, Subquery
...
class ComprehensiveWarnedRiskPartnerListSerializer(serializers.Serializer):
    id = serializers.CharField(source = "uuid")
    crm_code = serializers.CharField()
    name = serializers.CharField()
    tc_vkn_no = serializers.SerializerMethodField()
