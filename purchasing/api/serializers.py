    ...
    def get_lease(self, obj):
        if obj.lease:
            return {
                ...
                "activation_date" : obj.lease.activation_date.strftime("%d.%m.%Y") if obj.lease.activation_date else "",
                "contract_date" : obj.lease.signature_date.strftime("%d.%m.%Y") if obj.lease.signature_date else "",
