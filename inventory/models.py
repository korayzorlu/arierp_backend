...
class Item(models.Model):
    ...
    item_group_code = models.CharField(_("Item Group Code"), max_length=25, null=True, blank=True)
    item_group_name = models.CharField(_("Item Group Name"), max_length=250, null=True, blank=True)
    item_group_type = models.CharField(_("Item Group Type"), max_length=25, null=True, blank=True)
    fixed_asset_group = models.CharField(_("Fixed Asset Group"), max_length=50, null=True, blank=True)
    explanation = models.CharField(_("Explanation"), max_length=250, null=True, blank=True)
    item_group_type_id = models.CharField(_("Item Group Type ID"), max_length=25, null=True, blank=True)
    bddk_code = models.CharField(_("BDDK Code"), max_length=50, null=True, blank=True)
