...
class FinmaksTransaction(models.Model):
    ...
    SenderAccountName = models.CharField(_("Transaction Id"), max_length=25, null=True, blank=True)
    receiver_vkn = models.CharField(_("Receiver VKN"), max_length=25, null=True, blank=True)
    receiver_iban = models.CharField(_("Receiver IBAN"), max_length=25, null=True, blank=True)
