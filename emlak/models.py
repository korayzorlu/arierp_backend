...
class WhatsappMessage(models.Model):
    ...
    pesinat_amount = models.DecimalField(_("Peşinat Amount"), default = Decimal("0.00"), max_digits=14, decimal_places=2)
    taksit_amount = models.DecimalField(_("Taksit Amount"), default = Decimal("0.00"), max_digits=14, decimal_places=2)
