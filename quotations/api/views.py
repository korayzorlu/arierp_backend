...
class QuickQuotationList(ModelViewSet, QueryListAPIView):
    serializer_class = QuickQuotationListSerializer
    filterset_class = QuickQuotationFilter
    ...
    def get_queryset(self):
        ...
        if query:
            search_fields = ["code","partner__name","customer_type","customer_signature_date","currency__code","status__name","bbsn"]
