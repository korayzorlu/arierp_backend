...
class UpdatePartnerFinancialProfileView(LoginRequiredMixin,CompanyOwnershipRequiredMixin,View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        obj.other_assets_amount = data.get('other_assets_amount') if data.get('other_assets_amount') != "" else Decimal("0.00")
        obj.other_assets_description = data.get('other_assets_description')
